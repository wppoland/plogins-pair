...
/**
 * Elementor widget: Recently Viewed.
 *
 * A thin wrapper around the [pair_recently_viewed] shortcode so the "Recently
 * viewed" grid can be placed with the Elementor editor. Kept deliberately
...
/**
 * Recently Viewed Elementor widget.
 */
final class RecentlyViewedWidget extends Widget_Base
{
    /**
    ...
    {
        return esc_html__('Recently Viewed', 'plogins-pair');
    }
    ...
    {
        return ['pair', 'recently', 'viewed', 'history', 'browsing', 'woocommerce'];
    }
    ...
    protected function register_controls(): void
    {
        $this->start_controls_section(
            'content',
            ['label' => esc_html__('Recently viewed', 'plogins-pair')]
        );
    ...
    protected function render(): void
    {
        ...
        $shortcode = '[pair_recently_viewed';
        if ($count > 0) {
